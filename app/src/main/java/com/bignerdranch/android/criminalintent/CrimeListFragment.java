...
/**
 * Created by Andy Leekung on 5/17/2015.
 */
public class CrimeListFragment extends ListFragment {
                ...
                public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                    switch (item.getItemId()) {
                        case R.id.menu_item_delete_crime:
                            CrimeAdapter adapter = (CrimeAdapter)
                                    getListAdapter();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_item_show_subtitle:
                if (((AppCompatActivity)getActivity()).getSupportActionBar()
                    == null) {
                    ((AppCompatActivity)getActivity()).getSupportActionBar()
                            .setSubtitle(R.string.subtitle);
    ...
    private class CrimeAdapter extends ArrayAdapter<Crime> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            CheckBox solvedCheckBox = (CheckBox) convertView.findViewById(R
                    .id.crime_list_item_solvedCheckBox);
